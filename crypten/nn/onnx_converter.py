...
try:
  ...
  Registry = namedtuple("Registry",["is_registered_op", "get_registered_op", "register_op"])
  sym_registry = Registry(is_registered_op = is_registered_op, get_registered_op = get_registered_op, register_op=register_op)
import torch.onnx.utils
